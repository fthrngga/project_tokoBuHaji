...
/**
* @see \App\Http\Controllers\Settings\AddressController::primary
 * @see app/Http/Controllers/Settings/AddressController.php:51
 * @route '/settings/addresses/{address}/primary'
 */
export const primary = (args: { address: number | { id: number } } | [address: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'patch'> => ({
 ...
 * @route '/settings/addresses/{address}/primary'
 */
primary.url = (args: { address: number | { id: number } } | [address: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { address: args }
    }
 ...
 * @route '/settings/addresses/{address}/primary'
 */
primary.patch = (args: { address: number | { id: number } } | [address: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'patch'> => ({
    url: primary.url(args, options),
    method: 'patch',
})
 ...
 * @route '/settings/addresses/{address}/primary'
 */
    const primaryForm = (args: { address: number | { id: number } } | [address: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
 ...
 * @route '/settings/addresses/{address}/primary'
 */
        primaryForm.patch = (args: { address: number | { id: number } } | [address: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: primary.url(args, {
                        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                            _method: 'PATCH',
                            ...(options?.query ?? options?.mergeQuery ?? {}),

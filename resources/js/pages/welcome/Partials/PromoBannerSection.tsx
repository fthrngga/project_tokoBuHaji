            ...
            <div className="container mx-auto px-0 md:px-6 lg:px-8">
                <div className="grid grid-cols-1 md:grid-cols-2 items-center">
                    <div className="p-12 md:p-16 lg:p-24 flex flex-col justify-center text-left order-2 md:order-1">
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl font-semibold tracking-tight text-slate-900 dark:text-foreground leading-tight">
                        ...
                        <div className="mt-10">
                            <Link
                                href="/kategori/mebel"
                                className="inline-flex h-12 items-center justify-center rounded-full bg-slate-900 dark:bg-white px-8 text-sm font-medium text-foreground dark:text-slate-900 shadow-sm hover:bg-slate-800 dark:hover:bg-slate-100 transition-colors"
                            >
                                Mulai Menjelajah
                            </Link>
                        </div>

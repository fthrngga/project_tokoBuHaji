...
export default function EditorialCraftsmanship() {
    return (
        <section className="bg-transparent pb-16 md:pb-[96px]">
            <div className="max-w-[1440px] mx-auto px-6 md:px-12">
                <div
                    className="flex flex-col md:grid md:grid-cols-2 gap-0 overflow-hidden rounded-[20px] md:rounded-[24px] border border-border/10 min-h-[400px] md:min-h-[520px]"
                >
                    {/* Left: Content */}
                    <div
                        className="flex flex-col justify-center px-6 py-10 sm:px-10 md:px-14 md:py-16 bg-card z-10"
                    >
                        ...
                        <h2
                            className="text-3xl md:text-[clamp(28px,3.5vw,48px)] font-extrabold tracking-tight leading-[1.1] text-foreground m-0 mb-4 md:mb-6"
                        >
                            Melayani Kebutuhan Rumah Anda.
                        </h2>

                        <p
                            className="text-sm md:text-[15px] leading-relaxed text-muted-foreground/50 max-w-[380px] m-0"
                        >
                        ...
                        <p
                            className="text-xs md:text-[13px] font-medium text-muted-foreground/35 italic m-0"
                        >

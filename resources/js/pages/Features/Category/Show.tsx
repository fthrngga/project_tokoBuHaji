                ...
                <main className="flex-1 pb-32">
                                ...
                                <div className="mt-12 flex items-center gap-3 overflow-x-auto pb-4 hide-scrollbar animate-in fade-in duration-700 delay-300">
                                    ...
                                    <Link 
                                        ...
                                        className={`shrink-0 px-6 py-2.5 rounded-full text-sm font-medium border transition-all ${
                                            !isChild 
                                            ? 'bg-[#FE5F55] text-foreground border-[#FE5F55] shadow-[0_4px_15px_rgba(254,95,85,0.4)] hover:scale-105' 
                                            : 'bg-card text-muted-foreground border-border/30 hover:border-[#FE5F55]/50 hover:bg-[#577399]/10 hover:text-foreground'
                                        }`}
                                    >
                                        Semua
                                    </Link>
                    ...
                    <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16">
                        {products.data.length > 0 ? (
                            ...
                            <div className="text-center py-32 bg-card backdrop-blur-sm rounded-3xl border border-border/20 mt-8">
                                <h3 className="text-2xl font-medium text-foreground mb-3">Koleksi Belum Tersedia</h3>
                                ...
                                <Link
                                    href="/"
                                    className="inline-flex items-center justify-center px-8 py-3 rounded-full font-medium text-foreground shadow-lg hover:shadow-xl hover:-translate-y-0.5 transition-all duration-300"
                                        ...
                                        link.url ? (
                                            <Link
                                                ...
                                                className={`flex items-center justify-center min-w-[40px] h-10 px-3 text-sm font-medium rounded-full transition-colors ${link.active
                                                    ? "bg-[#FE5F55] text-foreground shadow-[0_4px_15px_rgba(254,95,85,0.4)]"
                                                    : "text-muted-foreground bg-card border border-border/30 hover:border-[#FE5F55]/50"
                                                    }`}

 ...
 * @see app/Http/Controllers/Admin/OrderController.php:12
 * @route '/admin/orders'
 */
 ...
 * @see app/Http/Controllers/Admin/OrderController.php:20
...
const OrderController = { index, create, store, show, edit, update, destroy }
